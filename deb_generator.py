...
p.description = "Geeknote - is a command line client for Evernote, " \
...
# project files
project_files = ["geeknote.py", "gnsync.py", "argparser.py",
                 "editor.py", "log.py", "oauth.py",
                 "out.py", "storage.py", "tools.py",
                 "config.py"]
